...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   private void onUpdateWalkingPlayer() {
      ...
      boolean flag3 = this.func_213838_H();
   ...
   public boolean func_213287_bg() {
      if (!this.abilities.isFlying && !this.isSwimming() && this.func_213298_c(Pose.SNEAKING)) {
   ...
   public void livingTick() {
      ...
      this.movementInput.func_217607_a(flag3, this.isSpectator());
