...
public class Main {
   ...
   public static void main(String[] p_main_0_) {
      ...
      Optional<Integer> optional = Optional.ofNullable(getValue(optionset, optionspec15));
      Optional<Integer> optional1 = Optional.ofNullable(getValue(optionset, optionspec16));
