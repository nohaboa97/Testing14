...
public final class Monitor {
   private final MonitorHandler virtualScreen;
   ...
   public Monitor(MonitorHandler virtualScreenIn, long monitorPointerIn) {
   ...
   public int getVideoModeOrDefaultIndex(Optional<VideoMode> optionalVideoMode) {
      if (optionalVideoMode.isPresent()) {
         VideoMode videomode = optionalVideoMode.get();
