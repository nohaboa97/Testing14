...
public class StonecutterScreen extends ContainerScreen<StonecutterContainer> {
   private static final ResourceLocation field_214146_k = new ResourceLocation("textures/gui/container/stonecutter.png");
   private float field_214147_l;
   private boolean field_214148_m;
   private int field_214149_n;
   ...
   public StonecutterScreen(StonecutterContainer p_i51076_1_, PlayerInventory p_i51076_2_, ITextComponent p_i51076_3_) {
      ...
      p_i51076_1_.func_217071_a(this::func_214145_d);
   }
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      this.minecraft.getTextureManager().bindTexture(field_214146_k);
      int i = this.guiLeft;
      int j = this.guiTop;
      this.blit(i, j, 0, 0, this.xSize, this.ySize);
      int k = (int)(41.0F * this.field_214147_l);
      this.blit(i + 119, j + 15 + k, 176 + (this.func_214143_c() ? 0 : 12), 0, 12, 15);
      int l = this.guiLeft + 52;
      int i1 = this.guiTop + 14;
      int j1 = this.field_214149_n + 12;
   ...
   private void func_214141_a(int p_214141_1_, int p_214141_2_, int p_214141_3_, int p_214141_4_, int p_214141_5_) {
      for(int i = this.field_214149_n; i < p_214141_5_ && i < this.container.func_217075_g(); ++i) {
         int j = i - this.field_214149_n;
   ...
   private void func_214142_b(int p_214142_1_, int p_214142_2_, int p_214142_3_) {
      ...
      List<StonecuttingRecipe> list = this.container.func_217076_f();

      for(int i = this.field_214149_n; i < p_214142_3_ && i < this.container.func_217075_g(); ++i) {
         int j = i - this.field_214149_n;
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      ...
      if (this.field_214150_o) {
         ...
         int k = this.field_214149_n + 12;

         for(int l = this.field_214149_n; l < k; ++l) {
            int i1 = l - this.field_214149_n;
   ...
   public boolean mouseDragged(double p_mouseDragged_1_, double p_mouseDragged_3_, int p_mouseDragged_5_, double p_mouseDragged_6_, double p_mouseDragged_8_) {
      if (this.field_214148_m && this.func_214143_c()) {
         int i = this.guiTop + 14;
         int j = i + 54;
         this.field_214147_l = ((float)p_mouseDragged_3_ - (float)i - 7.5F) / ((float)(j - i) - 15.0F);
         this.field_214147_l = MathHelper.clamp(this.field_214147_l, 0.0F, 1.0F);
         this.field_214149_n = (int)((double)(this.field_214147_l * (float)this.func_214144_b()) + 0.5D) * 4;
         return true;
      } else {
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      if (this.func_214143_c()) {
         int i = this.func_214144_b();
         this.field_214147_l = (float)((double)this.field_214147_l - p_mouseScrolled_5_ / (double)i);
         this.field_214147_l = MathHelper.clamp(this.field_214147_l, 0.0F, 1.0F);
         this.field_214149_n = (int)((double)(this.field_214147_l * (float)i) + 0.5D) * 4;
      }

      return true;
   }

   private boolean func_214143_c() {
      return this.field_214150_o && this.container.func_217075_g() > 12;
   }

   protected int func_214144_b() {
      return (this.container.func_217075_g() + 4 - 1) / 4 - 3;
   }

   private void func_214145_d() {
      this.field_214150_o = this.container.func_217083_h();
      if (!this.field_214150_o) {
         this.field_214147_l = 0.0F;
         this.field_214149_n = 0;
      }
