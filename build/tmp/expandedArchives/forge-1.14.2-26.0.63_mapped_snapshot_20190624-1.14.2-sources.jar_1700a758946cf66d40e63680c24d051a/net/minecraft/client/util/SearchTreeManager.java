...
public class SearchTreeManager implements IResourceManagerReloadListener {
   ...
   public <T> void func_215357_a(SearchTreeManager.Key<T> p_215357_1_, IMutableSearchTree<T> p_215357_2_) {
      this.trees.put(p_215357_1_, p_215357_2_);
   }

   public <T> IMutableSearchTree<T> func_215358_a(SearchTreeManager.Key<T> p_215358_1_) {
