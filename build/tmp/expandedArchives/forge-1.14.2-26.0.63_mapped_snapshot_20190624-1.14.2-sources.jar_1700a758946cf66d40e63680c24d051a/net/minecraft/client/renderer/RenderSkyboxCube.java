...
public class RenderSkyboxCube {
   ...
   public void func_217616_a(Minecraft p_217616_1_, float p_217616_2_, float p_217616_3_, float p_217616_4_) {
      ...
      GlStateManager.multMatrix(Matrix4f.perspective(85.0D, (float)p_217616_1_.mainWindow.getFramebufferWidth() / (float)p_217616_1_.mainWindow.getFramebufferHeight(), 0.05F, 10.0F));
      ...
      for(int j = 0; j < 4; ++j) {
         ...
         GlStateManager.rotatef(p_217616_2_, 1.0F, 0.0F, 0.0F);
         GlStateManager.rotatef(p_217616_3_, 0.0F, 1.0F, 0.0F);

         for(int k = 0; k < 6; ++k) {
            p_217616_1_.getTextureManager().bindTexture(this.locations[k]);
   ...
   public CompletableFuture<Void> func_217617_a(TextureManager p_217617_1_, Executor p_217617_2_) {
      CompletableFuture<?>[] completablefuture = new CompletableFuture[6];

      for(int i = 0; i < completablefuture.length; ++i) {
         completablefuture[i] = p_217617_1_.loadAsync(this.locations[i], p_217617_2_);
      }
