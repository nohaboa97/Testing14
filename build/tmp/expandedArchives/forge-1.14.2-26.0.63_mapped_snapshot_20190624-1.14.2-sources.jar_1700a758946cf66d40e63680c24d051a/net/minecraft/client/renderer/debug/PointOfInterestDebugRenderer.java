...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   private void func_217704_b(PointOfInterestDebugRenderer.BrainInfo p_217704_1_) {
      ...
      if (flag) {
         for(String s2 : Lists.reverse(p_217704_1_.field_217753_g)) {
            func_217693_a(p_217704_1_.field_217750_d, i, s2, -3355444, 0.02F);
            ++i;
         }
      }
   ...
   public static class BrainInfo {
      ...
      public BrainInfo(UUID p_i51515_1_, int p_i51515_2_, String p_i51515_3_, String p_i51515_4_, int p_i51515_5_, IPosition p_i51515_6_, @Nullable Path p_i51515_7_) {
         this.field_217747_a = p_i51515_1_;
         this.field_217748_b = p_i51515_2_;
         this.field_217749_c = p_i51515_3_;
         this.field_222928_d = p_i51515_4_;
         this.field_222929_e = p_i51515_5_;
         this.field_217750_d = p_i51515_6_;
         this.field_222930_g = p_i51515_7_;
      }
