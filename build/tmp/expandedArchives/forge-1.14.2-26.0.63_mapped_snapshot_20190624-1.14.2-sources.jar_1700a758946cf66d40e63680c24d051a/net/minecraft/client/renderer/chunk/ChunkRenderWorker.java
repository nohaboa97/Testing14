...
public class ChunkRenderWorker implements Runnable {
   ...
   protected void processTask(final ChunkRenderTask generator) throws InterruptedException {
      ...
      Vec3d lvt_2_1_ = this.chunkRenderDispatcher.func_217671_b();
      float lvt_3_1_ = (float)lvt_2_1_.x;
      float lvt_4_1_ = (float)lvt_2_1_.y;
      float lvt_5_1_ = (float)lvt_2_1_.z;
      ChunkRenderTask.Type lvt_6_1_ = generator.getType();
      if (lvt_6_1_ == ChunkRenderTask.Type.REBUILD_CHUNK) {
         generator.getRenderChunk().rebuildChunk(lvt_3_1_, lvt_4_1_, lvt_5_1_, generator);
      } else if (lvt_6_1_ == ChunkRenderTask.Type.RESORT_TRANSPARENCY) {
      ...
      if (lvt_6_1_ == ChunkRenderTask.Type.REBUILD_CHUNK) {
         for(BlockRenderLayer blockrenderlayer : BlockRenderLayer.values()) {
            if (lvt_7_1_.isLayerStarted(blockrenderlayer)) {
               lvt_8_1_.add(this.chunkRenderDispatcher.uploadChunk(blockrenderlayer, generator.getRegionRenderCacheBuilder().getBuilder(blockrenderlayer), generator.getRenderChunk(), lvt_7_1_, generator.getDistanceSq()));
            }
         }
      } else if (lvt_6_1_ == ChunkRenderTask.Type.RESORT_TRANSPARENCY) {
         lvt_8_1_.add(this.chunkRenderDispatcher.uploadChunk(BlockRenderLayer.TRANSLUCENT, generator.getRegionRenderCacheBuilder().getBuilder(BlockRenderLayer.TRANSLUCENT), generator.getRenderChunk(), lvt_7_1_, generator.getDistanceSq()));
      }
