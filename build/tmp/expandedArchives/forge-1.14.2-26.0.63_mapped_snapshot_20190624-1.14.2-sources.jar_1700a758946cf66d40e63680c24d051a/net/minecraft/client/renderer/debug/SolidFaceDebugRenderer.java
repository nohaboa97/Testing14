      ...
      for(BlockPos blockpos1 : BlockPos.getAllInBoxMutable(blockpos.add(-6, -6, -6), blockpos.add(6, 6, 6))) {
         ...
         if (blockstate.getBlock() != Blocks.AIR) {
            ...
            for(AxisAlignedBB axisalignedbb : voxelshape.toBoundingBoxList()) {
               ...
               float f2 = 0.0F;
               float f3 = 0.5F;
               if (Block.hasSolidSide(blockstate, iblockreader, blockpos1, Direction.WEST)) {
               ...
               if (Block.hasSolidSide(blockstate, iblockreader, blockpos1, Direction.SOUTH)) {
               ...
               if (Block.hasSolidSide(blockstate, iblockreader, blockpos1, Direction.EAST)) {
               ...
               if (Block.hasSolidSide(blockstate, iblockreader, blockpos1, Direction.NORTH)) {
               ...
               if (Block.hasSolidSide(blockstate, iblockreader, blockpos1, Direction.DOWN)) {
               ...
               if (Block.hasSolidSide(blockstate, iblockreader, blockpos1, Direction.UP)) {
