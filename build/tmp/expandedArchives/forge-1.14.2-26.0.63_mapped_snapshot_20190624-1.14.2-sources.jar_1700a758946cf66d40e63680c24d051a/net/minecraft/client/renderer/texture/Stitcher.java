...
public class Stitcher {
   ...
   public void doStitch() {
      ...
      for(Stitcher.Holder stitcher$holder : list) {
         bar.step(stitcher$holder.sprite.getName().toString());
         if (!this.allocateSlot(stitcher$holder)) {
            LOGGER.info(String.format("Unable to fit: %s - size: %dx%d - Maybe try a lower resolution resourcepack?", stitcher$holder.sprite.getName(), stitcher$holder.sprite.getWidth(), stitcher$holder.sprite.getHeight()));
