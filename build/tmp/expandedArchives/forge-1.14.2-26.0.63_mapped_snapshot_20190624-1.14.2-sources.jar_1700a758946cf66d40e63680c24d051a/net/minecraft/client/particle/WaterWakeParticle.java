...
public class WaterWakeParticle extends SpriteTexturedParticle {
   ...
   private WaterWakeParticle(World p_i50993_1_, double p_i50993_2_, double p_i50993_4_, double p_i50993_6_, double p_i50993_8_, double p_i50993_10_, double p_i50993_12_, IAnimatedSprite p_i50993_14_) {
      ...
      this.func_217566_b(p_i50993_14_);
   ...
   public void tick() {
      ...
      if (this.maxAge-- <= 0) {
         ...
         this.setSize(f, f);
         this.setSprite(this.field_217589_C.func_217591_a(i % 4, 4));
      }
   }

   @OnlyIn(Dist.CLIENT)
   public static class Factory implements IParticleFactory<BasicParticleType> {
      private final IAnimatedSprite field_217555_a;

      public Factory(IAnimatedSprite p_i51267_1_) {
         this.field_217555_a = p_i51267_1_;
      }

      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new WaterWakeParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.field_217555_a);
      }
   }
}