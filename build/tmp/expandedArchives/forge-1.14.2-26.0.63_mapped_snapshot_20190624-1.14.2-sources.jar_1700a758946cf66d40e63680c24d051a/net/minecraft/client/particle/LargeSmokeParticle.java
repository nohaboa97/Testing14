...
public class LargeSmokeParticle extends SmokeParticle {
   ...
   public static class Factory implements IParticleFactory<BasicParticleType> {
      private final IAnimatedSprite field_217535_a;

      public Factory(IAnimatedSprite p_i50554_1_) {
         this.field_217535_a = p_i50554_1_;
      }

      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new LargeSmokeParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.field_217535_a);
      }
   }
}