   ...
   public void handleCustomPayload(SCustomPayloadPlayPacket packetIn) {
      ...
      try {
         ...
         if (SCustomPayloadPlayPacket.BRAND.equals(resourcelocation)) {
            ...
            this.client.debugRenderer.structure.addStructure(mutableboundingbox, list2, list3, i2);
            ...
            PointOfInterestDebugRenderer.POIInfo pointofinterestdebugrenderer$poiinfo = new PointOfInterestDebugRenderer.POIInfo(blockpos2, s6, k4);
            ...
            this.client.debugRenderer.field_217741_m.func_217706_a(blockpos4, l3);
            ...
            List<EntityAIDebugRenderer.Entry> list4 = Lists.newArrayList();

            for(int k5 = 0; k5 < j5; ++k5) {
               int l = packetbuffer.readInt();
               boolean flag = packetbuffer.readBoolean();
               String s = packetbuffer.readString(255);
               list4.add(new EntityAIDebugRenderer.Entry(blockpos5, l, s, flag));
            }

            this.client.debugRenderer.field_217742_n.func_217682_a(l4, list4);
         } else if (SCustomPayloadPlayPacket.DEBUG_RAIDS.equals(resourcelocation)) {
            int l2 = packetbuffer.readInt();
            ...
            PointOfInterestDebugRenderer.BrainInfo pointofinterestdebugrenderer$braininfo = new PointOfInterestDebugRenderer.BrainInfo(uuid, l5, s1, s2, i1, iposition, path1);
            int j1 = packetbuffer.readInt();

            for(int k1 = 0; k1 < j1; ++k1) {
               String s3 = packetbuffer.readString();
               pointofinterestdebugrenderer$braininfo.field_217751_e.add(s3);
            }
            ...
            for(int j6 = 0; j6 < i6; ++j6) {
               ...
               pointofinterestdebugrenderer$braininfo.field_217752_f.add(s4);
            }
            ...
            for(int l6 = 0; l6 < k6; ++l6) {
               ...
               pointofinterestdebugrenderer$braininfo.field_217753_g.add(s5);
            }
