...
public class SkyLightStorage extends SectionLightStorage<SkyLightStorage.StorageMap> {
   ...
   protected void func_215524_j(long p_215524_1_) {
      ...
      if (k < i + 1) {
         ...
         if (this.field_215558_o.contains(j)) {
            this.field_215556_m.add(p_215524_1_);
            this.field_215557_n.remove(p_215524_1_);
            if (k > (this.field_215539_f).field_215652_b) {
               ...
               this.field_215556_m.remove(l);
               this.field_215557_n.add(l);
            }
   ...
   protected void func_215523_k(long p_215523_1_) {
      ...
      if (flag) {
         this.field_215557_n.add(p_215523_1_);
         this.field_215556_m.remove(p_215523_1_);
      }
      ...
      if ((this.field_215539_f).field_215653_c.get(i) == j + 1) {
         ...
         if (this.func_215518_g(k)) {
            ...
            if (flag) {
               this.field_215556_m.add(k);
               this.field_215557_n.remove(k);
            }
         } else {
   ...
   protected void func_215526_b(long p_215526_1_, boolean p_215526_3_) {
      if (p_215526_3_ && this.field_215558_o.add(p_215526_1_)) {
         int k = (this.field_215539_f).field_215653_c.get(p_215526_1_);
         if (k != (this.field_215539_f).field_215652_b) {
            long l = SectionPos.asLong(SectionPos.extractX(p_215526_1_), k - 1, SectionPos.extractZ(p_215526_1_));
            this.field_215556_m.add(l);
            this.field_215557_n.remove(l);
            this.func_215552_e();
         }
      } else if (!p_215526_3_ && this.field_215558_o.remove(p_215526_1_)) {
