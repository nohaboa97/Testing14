      ...
      if (endPos == Long.MAX_VALUE) {
         ...
         if (direction == null) {
            ...
            if (atomicinteger.get() >= 15) {
               ...
               return VoxelShapes.doAdjacentCubeSidesFillSquare(voxelshape1, voxelshape, direction) ? 15 : startLevel + Math.max(1, atomicinteger.get());
            }
         }
      }
   }
      ...
      for(Direction direction : DIRECTIONS) {
         ...
         if (k != excludedSourcePos) {
            ...
            if (nibblearray1 != null) {
               int i1 = this.getEdgeLevel(k, pos, this.func_215622_a(nibblearray1, k));
               if (i > i1) {
                  i = i1;
               }
