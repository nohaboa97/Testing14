...
public class CaveEdge extends Placement<CaveEdgeConfig> {
   ...
   public Stream<BlockPos> getPositions(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> p_212848_2_, Random random, CaveEdgeConfig p_212848_4_, BlockPos pos) {
      ...
      return IntStream.range(0, bitset.length()).filter((p_215067_3_) -> {
         return bitset.get(p_215067_3_) && random.nextFloat() < p_212848_4_.probability;
