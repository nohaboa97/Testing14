...
public class TreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   ...
   public TreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51422_1_, boolean p_i51422_2_, int minTreeHeightIn, BlockState trunkState, BlockState leafState, boolean vinesGrowIn) {
