   ...
   public Raid badOmenTick(ServerPlayerEntity p_215170_1_) {
      if (p_215170_1_.isSpectator()) {
         ...
         if (dimensiontype == DimensionType.NETHER) {
            ...
            Optional<BlockPos> optional = this.world.func_217443_B().func_219147_b((p_215166_0_) -> {
               return p_215166_0_ == PointOfInterestType.MEETING;
            }, Objects::nonNull, blockpos, 64, PointOfInterestManager.Status.ANY);
            if (!optional.isPresent()) {
               optional = Optional.of(blockpos);
            }

            Raid raid = this.findOrCreateRaid(p_215170_1_.getServerWorld(), optional.get());
            boolean flag = false;
