...
public class TrackedEntity {
   ...
   public void func_219453_a() {
      ...
      if (this.trackedEntity.velocityChanged) {
         this.func_219451_a(new SEntityVelocityPacket(this.trackedEntity));
   ...
   private void sendMetadata() {
      ...
      if (entitydatamanager.isDirty()) {
         this.func_219451_a(new SEntityMetadataPacket(this.trackedEntity.getEntityId(), entitydatamanager, false));
      }
      ...
      if (this.trackedEntity instanceof LivingEntity) {
         ...
         if (!set.isEmpty()) {
            this.func_219451_a(new SEntityPropertiesPacket(this.trackedEntity.getEntityId(), set));
         }
