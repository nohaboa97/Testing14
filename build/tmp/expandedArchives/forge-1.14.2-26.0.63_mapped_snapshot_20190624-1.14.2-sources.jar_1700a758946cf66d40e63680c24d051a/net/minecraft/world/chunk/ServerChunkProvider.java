...
public class ServerChunkProvider extends AbstractChunkProvider {
   ...
   public ServerChunkProvider(ServerWorld worldIn, File worldDirectory, DataFixer dataFixer, TemplateManager p_i50705_4_, Executor p_i50705_5_, ChunkGenerator<?> chunkGeneratorIn, int p_i50705_7_, int p_i50705_8_, IChunkStatusListener p_i50705_9_, Supplier<DimensionSavedDataManager> p_i50705_10_) {
      this.world = worldIn;
      ...
      this.chunkManager = new ChunkManager(worldIn, worldDirectory, dataFixer, p_i50705_4_, p_i50705_5_, this.executor, this, this.getChunkGenerator(), p_i50705_9_, p_i50705_10_, p_i50705_7_, p_i50705_8_);
   ...
   private void func_217220_m() {
      ...
      if (!flag) {
         ...
         this.world.getProfiler().endSection();
         ObjectBidirectionalIterator<Entry<ChunkHolder>> objectbidirectionaliterator = this.chunkManager.func_219197_f();
   ...
   public void setViewDistance(int p_217219_1_, int p_217219_2_) {
      this.chunkManager.setViewDistance(p_217219_1_, p_217219_2_);
   }
