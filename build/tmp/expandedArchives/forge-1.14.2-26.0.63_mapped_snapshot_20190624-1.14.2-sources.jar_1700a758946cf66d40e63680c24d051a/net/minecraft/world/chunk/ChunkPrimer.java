...
public class ChunkPrimer implements IChunk {
   ...
   public BlockState getBlockState(BlockPos pos) {
      ...
      if (World.isYOutOfBounds(i)) {
         ...
         return ChunkSection.isEmpty(chunksection) ? Blocks.AIR.getDefaultState() : chunksection.get(pos.getX() & 15, i & 15, pos.getZ() & 15);
      }
   }
   ...
   public BlockState setBlockState(BlockPos pos, BlockState state, boolean isMoving) {
      ...
      if (j >= 0 && j < 256) {
         if (this.sections[j >> 4] == Chunk.EMPTY_SECTION && state.getBlock() == Blocks.AIR) {
            ...
            BlockState blockstate = chunksection.set(i & 15, j & 15, k & 15, state);
