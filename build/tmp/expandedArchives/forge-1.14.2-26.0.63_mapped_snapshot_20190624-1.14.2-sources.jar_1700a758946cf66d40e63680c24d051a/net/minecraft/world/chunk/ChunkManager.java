...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider {
   ...
   private int field_219248_B;

   public ChunkManager(ServerWorld p_i50715_1_, File p_i50715_2_, DataFixer p_i50715_3_, TemplateManager p_i50715_4_, Executor p_i50715_5_, ThreadTaskExecutor<Runnable> p_i50715_6_, IChunkLightProvider p_i50715_7_, ChunkGenerator<?> p_i50715_8_, IChunkStatusListener p_i50715_9_, Supplier<DimensionSavedDataManager> p_i50715_10_, int p_i50715_11_, int p_i50715_12_) {
      super(new File(p_i50715_1_.getDimension().getType().getDirectory(p_i50715_2_), "region"), p_i50715_3_);
      this.field_219269_w = p_i50715_4_;
      this.field_219270_x = p_i50715_1_.getDimension().getType().getDirectory(p_i50715_2_);
      this.world = p_i50715_1_;
      this.generator = p_i50715_8_;
      this.field_219257_k = p_i50715_6_;
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor = DelegatedTaskExecutor.create(p_i50715_5_, "worldgen");
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor1 = DelegatedTaskExecutor.create(p_i50715_6_, "main");
      this.field_219266_t = p_i50715_9_;
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor2 = DelegatedTaskExecutor.create(p_i50715_5_, "light");
      this.field_219263_q = new ChunkTaskPriorityQueueSorter(ImmutableList.of(delegatedtaskexecutor, delegatedtaskexecutor1, delegatedtaskexecutor2), p_i50715_5_, Integer.MAX_VALUE);
      ...
      this.lightManager = new ServerWorldLightManager(p_i50715_7_, this, this.world.getDimension().hasSkyLight(), delegatedtaskexecutor2, this.field_219263_q.func_219087_a(delegatedtaskexecutor2, false));
      this.ticketManager = new ChunkManager.ProxyTicketManager(p_i50715_5_, p_i50715_6_);
      this.field_219259_m = p_i50715_10_;
      this.field_219260_n = new PointOfInterestManager(new File(this.field_219270_x, "poi"), p_i50715_3_);
      this.setViewDistance(p_i50715_11_, p_i50715_12_);
   }
   ...
   protected void setViewDistance(int viewDistance, int p_219175_2_) {
      ...
      if (i != this.viewDistance) {
         ...
         for(ChunkHolder chunkholder : this.field_219251_e.values()) {
            ...
            this.getTrackingPlayers(chunkpos, false).forEach((p_219224_4_) -> {
               int l = func_219215_b(chunkpos, p_219224_4_, true);
               boolean flag = l <= j;
      ...
      int k = MathHelper.clamp(p_219175_2_ + 1, 1, 16);
      if (k != this.field_219248_B) {
         this.field_219248_B = k;
         this.ticketManager.func_219351_a(this.field_219248_B);
      }
   ...
   protected ObjectBidirectionalIterator<Entry<ChunkHolder>> func_219197_f() {
      return this.field_219252_f.long2ObjectEntrySet().fastIterator();
   }
   ...
   boolean isOutsideSpawningRadius(ChunkPos chunkPosIn) {
      return this.playerGenerationTracker.getGeneratingPlayers(chunkPosIn.asLong()).noneMatch((p_219201_1_) -> {
   ...
   private boolean cannotGenerateChunks(ServerPlayerEntity player) {
      return player.isSpectator() && !this.world.getGameRules().getBoolean("spectatorsGenerateChunks");
   }
   ...
   void setPlayerTracking(ServerPlayerEntity player, boolean track) {
      ...
      for(int l = i - this.viewDistance; l <= i + this.viewDistance; ++l) {
         for(int k = j - this.viewDistance; k <= j + this.viewDistance; ++k) {
            ...
            this.setClientChunkLoaded(player, chunkpos, new IPacket[2], !track && !flag1, track && !flag);
         }
      }
         ...
         if (Math.abs(k - l1) <= this.viewDistance * 2 && Math.abs(l - i2) <= this.viewDistance * 2) {
            ...
            for(int l3 = k2; l3 <= j3; ++l3) {
               for(int k1 = i3; k1 <= k3; ++k1) {
                  ...
                  boolean flag5 = !flag && getChunkDistance(chunkpos1, k, l) <= this.viewDistance;
                  boolean flag6 = !flag1 && getChunkDistance(chunkpos1, l1, i2) <= this.viewDistance;
            ...
            for(int i1 = k - this.viewDistance; i1 <= k + this.viewDistance; ++i1) {
               for(int j1 = l - this.viewDistance; j1 <= l + this.viewDistance; ++j1) {
                  ...
                  boolean flag3 = !flag;
                  boolean flag4 = false;
                  this.setClientChunkLoaded(player, chunkpos, new IPacket[2], flag3, false);
               }
            }
            ...
            for(int j2 = l1 - this.viewDistance; j2 <= l1 + this.viewDistance; ++j2) {
               for(int l2 = i2 - this.viewDistance; l2 <= i2 + this.viewDistance; ++l2) {
                  ...
                  boolean flag7 = false;
                  boolean flag8 = !flag1;
                  this.setClientChunkLoaded(player, chunkpos2, new IPacket[2], false, flag8);
               }
            }
         }
