...
public class MapData extends WorldSavedData {
   ...
   public void read(CompoundNBT nbt) {
      ...
      this.field_215161_h = nbt.getBoolean("locked");
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ...
      compound.putBoolean("locked", this.field_215161_h);
   ...
   public void updateVisiblePlayers(PlayerEntity player, ItemStack mapStack) {
      ...
      if (mapStack.isOnItemFrame() && this.trackingPosition) {
         ...
         MapFrame mapframe = new MapFrame(blockpos, itemframeentity.facingDirection.getHorizontalIndex() * 90, itemframeentity.getEntityId());
         this.updateDecorations(MapDecoration.Type.FRAME, player.world, "frame-" + itemframeentity.getEntityId(), (double)blockpos.getX(), (double)blockpos.getZ(), (double)(itemframeentity.facingDirection.getHorizontalIndex() * 90), (ITextComponent)null);
         this.frames.put(mapframe.func_212767_e(), mapframe);
      }
   ...
   public class MapInfo {
      ...
      public IPacket<?> getPacket(ItemStack stack) {
         if (this.isDirty) {
            this.isDirty = false;
            return new SMapDataPacket(FilledMapItem.getMapId(stack), MapData.this.scale, MapData.this.trackingPosition, MapData.this.field_215161_h, MapData.this.mapDecorations.values(), MapData.this.colors, this.minX, this.minY, this.maxX + 1 - this.minX, this.maxY + 1 - this.minY);
         } else {
            return this.tick++ % 5 == 0 ? new SMapDataPacket(FilledMapItem.getMapId(stack), MapData.this.scale, MapData.this.trackingPosition, MapData.this.field_215161_h, MapData.this.mapDecorations.values(), MapData.this.colors, 0, 0, 0, 0) : null;
         }
      }
