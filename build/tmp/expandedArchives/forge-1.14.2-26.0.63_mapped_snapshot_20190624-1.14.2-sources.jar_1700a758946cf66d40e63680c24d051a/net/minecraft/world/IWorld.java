...
public interface IWorld extends IEntityReader, IWorldReader, IWorldGenerationReader {
   ...
   default void playEvent(int p_217379_1_, BlockPos pos, int p_217379_3_) {
      this.playEvent((PlayerEntity)null, p_217379_1_, pos, p_217379_3_);
   }

   default Stream<VoxelShape> getCollisionBoxes(@Nullable Entity entityIn, VoxelShape shape, Set<Entity> breakOnEntityCollide) {
      return IEntityReader.super.getCollisionBoxes(entityIn, shape, breakOnEntityCollide);
   }
