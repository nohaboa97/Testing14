...
public interface IEntityReader {
   ...
   default Stream<VoxelShape> getCollisionBoxes(@Nullable Entity entityIn, VoxelShape shape, Set<Entity> breakOnEntityCollide) {
      if (shape.isEmpty()) {
         ...
         return this.getEntitiesWithinAABBExcludingEntity(entityIn, axisalignedbb.grow(0.25D)).stream().filter((p_217367_2_) -> {
            return !breakOnEntityCollide.contains(p_217367_2_) && (entityIn == null || !entityIn.isRidingSameEntity(p_217367_2_));
         }).flatMap((p_217368_2_) -> {
            return Stream.of(p_217368_2_.getCollisionBoundingBox(), entityIn == null ? null : entityIn.getCollisionBox(p_217368_2_)).filter(Objects::nonNull).filter((p_217363_1_) -> {
               return p_217363_1_.intersects(axisalignedbb);
