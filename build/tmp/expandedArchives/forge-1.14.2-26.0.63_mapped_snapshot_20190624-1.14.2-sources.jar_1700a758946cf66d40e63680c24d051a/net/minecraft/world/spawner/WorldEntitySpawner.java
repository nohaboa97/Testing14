                  ...
                  label108: {
                     if (k2 < i2) {
                        label116: {
                           ...
                           if (entityspawnplacementregistry$placementtype == null || !canCreatureTypeSpawnAtLocation(entityspawnplacementregistry$placementtype, p_222263_1_, blockpos$mutableblockpos, entitytype) || !p_222263_1_.areCollisionShapesEmpty(entitytype.func_220328_a((double)f, (double)k, (double)f1))) {
                              break label108;
                           }
            ...
            for(int l1 = 0; l1 < k; ++l1) {
               ...
               for(int i2 = 0; !flag && i2 < 4; ++i2) {
                  ...
                  if (biome$spawnlistentry.entityType.isSummonable() && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, worldIn, blockpos, biome$spawnlistentry.entityType)) {
                     ...
                     if (!worldIn.areCollisionShapesEmpty(biome$spawnlistentry.entityType.func_220328_a(d0, (double)blockpos.getY(), d1))) {
                        continue;
                     }
