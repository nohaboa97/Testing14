...
public class PointOfInterestManager extends RegionSectionCache<PointOfInterestData> {
   ...
   private Stream<PointOfInterest> func_219146_b(Predicate<PointOfInterestType> p_219146_1_, BlockPos p_219146_2_, int distance, PointOfInterestManager.Status p_219146_4_) {
   ...
   protected void func_219116_a(long p_219116_1_) {
      ...
      this.field_219164_a.updateSourceLevel(p_219116_1_, this.field_219164_a.getSourceLevel(p_219116_1_), false);
   }
