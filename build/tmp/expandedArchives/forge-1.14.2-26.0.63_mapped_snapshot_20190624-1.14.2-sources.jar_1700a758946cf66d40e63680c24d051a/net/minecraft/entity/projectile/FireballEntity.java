   ...
   protected void onImpact(RayTraceResult result) {
      if (!this.world.isRemote) {
         if (result.getType() == RayTraceResult.Type.ENTITY) {
            ...
            entity.attackEntityFrom(DamageSource.causeFireballDamage(this, this.field_70235_a), 6.0F);
            this.applyEnchantments(this.field_70235_a, entity);
         }

         boolean flag = net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this.field_70235_a);
