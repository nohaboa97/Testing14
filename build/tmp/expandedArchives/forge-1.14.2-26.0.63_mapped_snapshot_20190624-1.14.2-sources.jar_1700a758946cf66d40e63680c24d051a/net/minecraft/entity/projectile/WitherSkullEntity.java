      ...
      if (!this.world.isRemote) {
         if (result.getType() == RayTraceResult.Type.ENTITY) {
            ...
            if (this.field_70235_a != null) {
               if (entity.attackEntityFrom(DamageSource.causeMobDamage(this.field_70235_a), 8.0F)) {
                  if (entity.isAlive()) {
                     this.applyEnchantments(this.field_70235_a, entity);
                  } else {
                     this.field_70235_a.heal(5.0F);
                  }
               }
            } else {
         ...
         Explosion.Mode explosion$mode = net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this.field_70235_a) ? Explosion.Mode.DESTROY : Explosion.Mode.NONE;
