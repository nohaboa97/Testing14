...
public class DragonFireballEntity extends DamagingProjectileEntity {
   ...
   protected void onImpact(RayTraceResult result) {
      if (result.getType() != RayTraceResult.Type.ENTITY || !((EntityRayTraceResult)result).getEntity().isEntityEqual(this.field_70235_a)) {
         if (!this.world.isRemote) {
            ...
            areaeffectcloudentity.setOwner(this.field_70235_a);
