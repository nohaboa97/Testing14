      ...
      if (!this.world.isRemote) {
         if (result.getType() == RayTraceResult.Type.ENTITY) {
            ...
            if (!entity.isImmuneToFire()) {
               entity.setFire(5);
               boolean flag = entity.attackEntityFrom(DamageSource.causeFireballDamage(this, this.field_70235_a), 5.0F);
               if (flag) {
                  this.applyEnchantments(this.field_70235_a, entity);
               }
            }
         } else if (this.field_70235_a == null || !(this.field_70235_a instanceof MobEntity) || net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this.field_70235_a)) {
