...
public abstract class HangingEntity extends Entity {
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      this.updateFacingWithBoundingBox(Direction.byHorizontalIndex(compound.getByte("Facing")));
   }
   ...
   public float getRotatedYaw(Rotation transformRotation) {
      if (this.facingDirection != null && this.facingDirection.getAxis() != Direction.Axis.Y) {
