...
public class VillagerData {
   ...
   public VillagerData withType(IVillagerType p_221134_1_) {
      return new VillagerData(p_221134_1_, this.profession, this.level);
   }

   public VillagerData withProfession(VillagerProfession p_221126_1_) {
      return new VillagerData(this.type, p_221126_1_, this.level);
   }

   public VillagerData withLevel(int p_221135_1_) {
