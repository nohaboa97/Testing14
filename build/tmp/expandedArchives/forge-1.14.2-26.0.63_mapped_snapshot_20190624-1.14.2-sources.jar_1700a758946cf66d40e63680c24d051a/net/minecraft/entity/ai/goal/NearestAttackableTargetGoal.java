...
public class NearestAttackableTargetGoal<T extends LivingEntity> extends TargetGoal {
   ...
   protected void func_220778_g() {
      if (this.targetClass != PlayerEntity.class && this.targetClass != ServerPlayerEntity.class) {
         this.field_75309_a = this.field_75299_d.world.<T>getClosestEntityWithinAABB(this.targetClass, this.field_220779_d, this.field_75299_d, this.field_75299_d.posX, this.field_75299_d.posY + (double)this.field_75299_d.getEyeHeight(), this.field_75299_d.posZ, this.getTargetableArea(this.getTargetDistance()));
      } else {
         this.field_75309_a = this.field_75299_d.world.getClosestPlayer(this.field_220779_d, this.field_75299_d, this.field_75299_d.posX, this.field_75299_d.posY + (double)this.field_75299_d.getEyeHeight(), this.field_75299_d.posZ);
      }
