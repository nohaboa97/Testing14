...
public class MovementController {
   ...
   public void tick() {
      if (this.action == MovementController.Action.STRAFE) {
         ...
         if (d2 > (double)this.mob.stepHeight && d0 * d0 + d1 * d1 < (double)Math.max(1.0F, this.mob.getWidth()) || !voxelshape.isEmpty() && this.mob.posY < voxelshape.getEnd(Direction.Axis.Y) + (double)blockpos.getY()) {
