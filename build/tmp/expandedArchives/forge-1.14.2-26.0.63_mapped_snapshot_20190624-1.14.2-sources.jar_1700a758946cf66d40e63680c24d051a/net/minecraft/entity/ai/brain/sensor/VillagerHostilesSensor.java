...
public class VillagerHostilesSensor extends Sensor<LivingEntity> {
   private static final ImmutableMap<EntityType<?>, Float> field_220991_b = ImmutableMap.<EntityType<?>, Float>builder().put(EntityType.ZOMBIE, 8.0F).put(EntityType.EVOKER, 12.0F).put(EntityType.VINDICATOR, 10.0F).put(EntityType.VEX, 8.0F).put(EntityType.PILLAGER, 15.0F).put(EntityType.ILLUSIONER, 12.0F).put(EntityType.RAVAGER, 12.0F).put(EntityType.HUSK, 8.0F).build();
