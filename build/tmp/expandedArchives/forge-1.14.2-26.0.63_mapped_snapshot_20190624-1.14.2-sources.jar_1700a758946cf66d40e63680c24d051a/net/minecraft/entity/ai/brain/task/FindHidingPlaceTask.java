...
public class FindHidingPlaceTask extends Task<LivingEntity> {
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      if (optional.isPresent()) {
         ...
         brain.setMemory(MemoryModuleType.HIDING_PLACE, GlobalPos.of(p_212831_1_.getDimension().getType(), optional.get()));
         if (!optional.get().withinDistance(p_212831_2_.getPositionVec(), (double)this.field_220459_c)) {
