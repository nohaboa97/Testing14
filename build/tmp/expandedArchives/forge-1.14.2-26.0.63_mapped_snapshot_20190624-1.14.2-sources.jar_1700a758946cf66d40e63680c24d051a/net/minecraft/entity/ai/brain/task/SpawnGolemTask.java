...
public class SpawnGolemTask extends Task<VillagerEntity> {
   ...
   public SpawnGolemTask() {
      super(ImmutableMap.of(MemoryModuleType.JOB_SITE, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.LOOK_TARGET, MemoryModuleStatus.REGISTERED, MemoryModuleType.GOLEM_SPAWN_CONDITIONS, MemoryModuleStatus.REGISTERED));
   }
   ...
   protected void updateTask(ServerWorld worldIn, VillagerEntity owner, long gameTime) {
      ...
      VillagerEntity.GolemStatus villagerentity$golemstatus = brain.getMemory(MemoryModuleType.GOLEM_SPAWN_CONDITIONS).orElseGet(VillagerEntity.GolemStatus::new);
      villagerentity$golemstatus.func_221143_a(gameTime);
      brain.setMemory(MemoryModuleType.GOLEM_SPAWN_CONDITIONS, villagerentity$golemstatus);
