...
public class FindWalkTargetTask extends Task<CreatureEntity> {
   ...
   public FindWalkTargetTask(float p_i50336_1_) {
      ...
      this.field_220597_a = p_i50336_1_;
   }
   ...
   private void func_220594_a(CreatureEntity p_220594_1_, SectionPos p_220594_2_) {
      ...
      Optional<Vec3d> optional = Optional.ofNullable(RandomPositionGenerator.findRandomTargetBlockTowards(p_220594_1_, 10, 7, new Vec3d((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ())));
   ...
   private void func_220593_a(CreatureEntity p_220593_1_) {
      Optional<Vec3d> optional = Optional.ofNullable(RandomPositionGenerator.getLandPos(p_220593_1_, 10, 7));
