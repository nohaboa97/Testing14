         ...
         if (!serverworld.func_217471_a(blockpos, 6)) {
            ...
            if (vec3d == null) {
               ...
               if (!optional.isPresent()) {
                  ...
                  this.path = groundpathnavigator.getPathToPos(this.field_220735_d);
                  ...
                  if (this.path == null) {
                     ...
                     groundpathnavigator.setBreakDoors(this.field_220737_h.getAsBoolean());
                     this.path = this.entity.getNavigator().getPathToXYZ(vec3d1.x, vec3d1.y, vec3d1.z);
                     groundpathnavigator.setBreakDoors(flag);
                     if (this.path == null) {
                        return false;
                     }
                  ...
                  for(int i = 0; i < this.path.getCurrentPathLength(); ++i) {
                     ...
                     if (InteractDoorGoal.func_220695_a(this.entity.world, blockpos1)) {
                        this.path = this.entity.getNavigator().getPathToXYZ((double)pathpoint.x, (double)pathpoint.y, (double)pathpoint.z);
                        break;
                     }
                  }
