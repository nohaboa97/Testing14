...
public class ClearHurtTask extends Task<LivingEntity> {
   ...
   private static boolean func_220394_a(LivingEntity p_220394_0_) {
      return p_220394_0_.getBrain().getMemory(MemoryModuleType.HURT_BY_ENTITY).filter((p_220393_1_) -> {
         return p_220393_1_.getDistanceSq(p_220394_0_) <= 36.0D;
      }).isPresent();
   }
}