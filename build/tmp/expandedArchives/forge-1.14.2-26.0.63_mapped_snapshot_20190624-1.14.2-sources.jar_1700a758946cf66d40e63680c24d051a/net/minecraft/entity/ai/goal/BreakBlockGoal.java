...
public class BreakBlockGoal extends MoveToBlockGoal {
   ...
   public boolean shouldExecute() {
      if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.entity.world, this.entity) || !this.entity.world.getBlockState(this.destinationBlock).canEntityDestroy(this.entity.world, this.destinationBlock, this.entity) || !net.minecraftforge.event.ForgeEventFactory.onEntityDestroyBlock(this.entity, this.destinationBlock, this.entity.world.getBlockState(this.destinationBlock))) {
         return false;
