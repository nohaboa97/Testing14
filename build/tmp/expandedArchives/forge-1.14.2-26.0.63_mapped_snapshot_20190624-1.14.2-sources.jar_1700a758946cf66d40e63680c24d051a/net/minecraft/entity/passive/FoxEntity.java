...
public class FoxEntity extends AnimalEntity {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, PlayerEntity.class, 16.0F, 1.6D, 1.4D, (p_213497_1_) -> {
         return field_213514_bH.test(p_213497_1_) && !this.isTrustedUUID(p_213497_1_.getUniqueID());
      }));
      this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, WolfEntity.class, 8.0F, 1.6D, 1.4D, (p_213469_0_) -> {
   ...
   protected float getStandingEyeHeight(Pose poseIn, EntitySize sizeIn) {
      return this.isChild() ? sizeIn.height * 0.95F : 0.4F;
   }
