...
public class CatEntity extends TameableEntity {
   ...
   static class MorningGiftGoal extends Goal {
      ...
      private void func_220804_h() {
         ...
         this.cat.func_213373_a((double)(blockpos$mutableblockpos.getX() + random.nextInt(11) - 5), (double)(blockpos$mutableblockpos.getY() + random.nextInt(5) - 2), (double)(blockpos$mutableblockpos.getZ() + random.nextInt(11) - 5), false);
         blockpos$mutableblockpos.setPos(this.cat);
