...
public class TurtleEntity extends AnimalEntity {
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      ...
      return blockpos.getY() < worldIn.getSeaLevel() + 4 && super.canSpawn(worldIn, spawnReasonIn);
   }
   ...
   static class WanderGoal extends RandomWalkingGoal {
       ...
       */
      public boolean shouldExecute() {
         return !this.field_75457_a.isInWater() && !this.turtle.isGoingHome() && !this.turtle.hasEgg() ? super.shouldExecute() : false;
      }
   }
}