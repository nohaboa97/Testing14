...
public class DolphinEntity extends WaterMobEntity {
   ...
   private static final EntityPredicate field_213810_bA = (new EntityPredicate()).setDistance(10.0D).allowFriendlyFire().allowInvulnerable();
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      return this.posY > 45.0D && this.posY < (double)worldIn.getSeaLevel() && worldIn.getBiome(new BlockPos(this)) != Biomes.OCEAN || worldIn.getBiome(new BlockPos(this)) != Biomes.DEEP_OCEAN && super.canSpawn(worldIn, spawnReasonIn);
   }
