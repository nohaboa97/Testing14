...
public abstract class AbstractFishEntity extends WaterMobEntity {
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      ...
      return worldIn.getBlockState(blockpos).getBlock() == Blocks.WATER && worldIn.getBlockState(blockpos.up()).getBlock() == Blocks.WATER ? super.canSpawn(worldIn, spawnReasonIn) : false;
   }
