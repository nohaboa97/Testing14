...
public abstract class AnimalEntity extends AgeableEntity {
   ...
   public float getBlockPathWeight(BlockPos pos, IWorldReader worldIn) {
      return worldIn.getBlockState(pos.down()).getBlock() == this.spawnableBlock ? 10.0F : worldIn.getBrightness(pos) - 0.5F;
   }
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      ...
      return worldIn.getBlockState(blockpos.down()).getBlock() == this.spawnableBlock && worldIn.getLightSubtracted(blockpos, 0) > 8 && super.canSpawn(worldIn, spawnReasonIn);
   }
