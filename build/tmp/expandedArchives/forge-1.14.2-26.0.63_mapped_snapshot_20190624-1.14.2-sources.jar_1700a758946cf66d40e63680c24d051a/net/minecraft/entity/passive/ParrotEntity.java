...
public class ParrotEntity extends ShoulderRidingEntity implements IFlyingAnimal {
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      ...
      return block.isIn(BlockTags.LEAVES) || block == Blocks.GRASS_BLOCK || block instanceof LogBlock || block == Blocks.AIR && super.canSpawn(worldIn, spawnReasonIn); //Forge: GRASS -> GRASS_BLOCK
   }
