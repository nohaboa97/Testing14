...
public abstract class AbstractRaiderEntity extends PatrollerEntity {
   ...
   private static final Predicate<ItemEntity> field_213665_b = (p_213647_0_) -> {
      return !p_213647_0_.cannotPickup() && p_213647_0_.isAlive() && ItemStack.areItemStacksEqual(p_213647_0_.getItem(), Raid.ILLAGER_BANNER);
   };
   @Nullable
   protected Raid raid;
   private int wave;
   ...
   public void onDeath(DamageSource cause) {
      if (this.world instanceof ServerWorld) {
         ...
         if (this.getRaid() != null) {
            if (this.isLeader()) {
               this.getRaid().removeLeader(this.func_213642_em());
            }
            ...
            this.getRaid().leaveRaid(this, false);
         }

         if (this.isLeader() && this.getRaid() == null && ((ServerWorld)this.world).findRaid(new BlockPos(this)) == null) {
            ...
            if (!itemstack.isEmpty() && ItemStack.areItemStacksEqual(itemstack, Raid.ILLAGER_BANNER) && playerentity != null) {
   ...
   protected void updateEquipmentIfNeeded(ItemEntity itemEntity) {
      ...
      if (this.isRaidActive() && !flag && ItemStack.areItemStacksEqual(itemstack, Raid.ILLAGER_BANNER)) {
   ...
   public class PromoteLeaderGoal<T extends AbstractRaiderEntity> extends Goal {
      ...
      public boolean shouldExecute() {
         ...
         if (this.field_220856_b.isRaidActive() && !this.field_220856_b.getRaid().func_221319_a() && this.field_220856_b.canBeLeader() && !ItemStack.areItemStacksEqual(this.field_220856_b.getItemStackFromSlot(EquipmentSlotType.HEAD), Raid.ILLAGER_BANNER)) {
