         ...
         if (event.getResult() == net.minecraftforge.eventbus.api.Event.Result.ALLOW  ||
            ...
            for(int l = 0; l < 50; ++l) {
               ...
               if (this.world.getBlockState(blockpos).func_215682_a(this.world, blockpos, zombieentity) && this.world.getLight(new BlockPos(i1, j1, k1)) < 10) {
                  ...
                  if (!this.world.isPlayerWithin((double)i1, (double)j1, (double)k1, 7.0D) && this.world.func_217346_i(zombieentity) && this.world.areCollisionShapesEmpty(zombieentity) && !this.world.containsAnyLiquid(zombieentity.getBoundingBox())) {
                     this.world.addEntity(zombieentity);
