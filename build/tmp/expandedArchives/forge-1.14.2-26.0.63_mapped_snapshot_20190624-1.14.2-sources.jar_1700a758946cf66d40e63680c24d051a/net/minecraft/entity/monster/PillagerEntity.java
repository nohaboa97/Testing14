...
public class PillagerEntity extends AbstractIllagerEntity implements ICrossbowUser, IRangedAttackMob {
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      return worldIn.getLightFor(LightType.BLOCK, new BlockPos(this.posX, this.posY, this.posZ)) > 8 ? false : super.canSpawn(worldIn, spawnReasonIn);
   }
   ...
   public boolean canDespawn(double distanceToClosestPlayer) {
      return super.canDespawn(distanceToClosestPlayer) && this.func_213674_eg().isEmpty();
   }
}