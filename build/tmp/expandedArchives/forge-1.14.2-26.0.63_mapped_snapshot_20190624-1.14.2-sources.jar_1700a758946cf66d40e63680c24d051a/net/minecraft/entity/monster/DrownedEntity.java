...
public class DrownedEntity extends ZombieEntity implements IRangedAttackMob {
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      ...
      if (biome != Biomes.RIVER && biome != Biomes.FROZEN_RIVER) {
         return this.rand.nextInt(40) == 0 && this.func_204712_dC() && super.canSpawn(worldIn, spawnReasonIn);
      } else {
         return this.rand.nextInt(15) == 0 && super.canSpawn(worldIn, spawnReasonIn);
      }
   }

   protected boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn, BlockPos posIn) {
      return worldIn.getFluidState(posIn).isTagged(FluidTags.WATER);
   }
