...
public abstract class MobEntity extends LivingEntity {
   ...
   public boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn) {
      return this.canSpawn(worldIn, spawnReasonIn, new BlockPos(this));
   }

   protected boolean canSpawn(IWorld worldIn, SpawnReason spawnReasonIn, BlockPos posIn) {
      BlockPos blockpos = posIn.down();
      return spawnReasonIn == SpawnReason.SPAWNER || worldIn.getBlockState(blockpos).canEntitySpawn(worldIn, blockpos, this.getType());
   }

   public boolean isNotColliding(IWorldReader worldIn) {
      return !worldIn.containsAnyLiquid(this.getBoundingBox()) && worldIn.func_217346_i(this);
   }
   ...
   protected boolean isInDaylight() {
      if (this.world.isDaytime() && !this.world.isRemote) {
         ...
         if (f > 0.5F && this.rand.nextFloat() * 30.0F < (f - 0.4F) * 2.0F && this.world.func_217337_f(blockpos)) {
            return true;
         }
      }
