...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
   ...
   private void func_213846_b(ServerWorld p_213846_1_) {
      ...
      if (dimensiontype == DimensionType.NETHER && dimensiontype1 == DimensionType.OVERWORLD && this.enteredNetherPosition != null) {
         CriteriaTriggers.NETHER_TRAVEL.trigger(this, this.enteredNetherPosition);
      }

      if (dimensiontype1 != DimensionType.NETHER) {
   ...
   public void func_213818_a(int p_213818_1_, MerchantOffers p_213818_2_, int p_213818_3_, int p_213818_4_, boolean p_213818_5_) {
      this.connection.sendPacket(new SMerchantOffersPacket(p_213818_1_, p_213818_2_, p_213818_3_, p_213818_4_, p_213818_5_));
   }
   ...
   public void openBook(ItemStack stack, Hand hand) {
      ...
      if (item == Items.WRITTEN_BOOK) {
         if (WrittenBookItem.func_220050_a(stack, this.getCommandSource(), this)) {
            this.openContainer.detectAndSendChanges();
         }
