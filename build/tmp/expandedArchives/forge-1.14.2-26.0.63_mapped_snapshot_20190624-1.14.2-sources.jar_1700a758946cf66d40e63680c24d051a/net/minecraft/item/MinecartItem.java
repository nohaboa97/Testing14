...
public class MinecartItem extends Item {
   private static final IDispenseItemBehavior MINECART_DISPENSER_BEHAVIOR = new DefaultDispenseItemBehavior() {
      ...
      public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
         ...
         AbstractMinecartEntity abstractminecartentity = AbstractMinecartEntity.create(world, d0, d1 + d3, d2, ((MinecartItem)stack.getItem()).field_77841_a);
   ...
   private final AbstractMinecartEntity.Type field_77841_a;

   public MinecartItem(AbstractMinecartEntity.Type minecartTypeIn, Item.Properties builder) {
      super(builder);
      this.field_77841_a = minecartTypeIn;
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
      ...
      if (!blockstate.isIn(BlockTags.RAILS)) {
         ...
         if (!world.isRemote) {
            ...
            AbstractMinecartEntity abstractminecartentity = AbstractMinecartEntity.create(world, (double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 0.0625D + d0, (double)blockpos.getZ() + 0.5D, this.field_77841_a);
