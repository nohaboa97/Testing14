...
public abstract class Registry<T> implements IObjectIntIterable<T> {
   ...
   public static final Registry<DimensionType> DIMENSION_TYPE = func_222939_a("dimension_type", net.minecraftforge.common.DimensionManager.getRegistry(), () -> {
   ...
   public static final Registry<Structure<?>> STRUCTURE_FEATURE = func_222935_a("structure_feature", () -> {
