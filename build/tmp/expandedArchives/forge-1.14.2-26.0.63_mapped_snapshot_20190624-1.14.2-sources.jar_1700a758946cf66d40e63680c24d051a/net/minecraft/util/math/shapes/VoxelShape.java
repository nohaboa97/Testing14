...
public abstract class VoxelShape {
   ...
   public VoxelShape func_212434_a(Direction side) {
      if (!this.isEmpty() && this != VoxelShapes.fullCube()) {
         if (this.field_222864_b != null) {
            VoxelShape voxelshape = this.field_222864_b[side.ordinal()];
            if (voxelshape != null) {
               return voxelshape;
            }
         } else {
         ...
         VoxelShape voxelshape1 = this.func_222863_b(side);
         this.field_222864_b[side.ordinal()] = voxelshape1;
         return voxelshape1;
      } else {
         return this;
      }
   ...
   private VoxelShape func_222863_b(Direction p_222863_1_) {
