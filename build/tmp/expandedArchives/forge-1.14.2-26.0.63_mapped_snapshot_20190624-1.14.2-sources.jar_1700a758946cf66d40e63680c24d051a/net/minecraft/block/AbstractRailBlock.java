...
public abstract class AbstractRailBlock extends Block {
   ...
   public void onBlockAdded(BlockState p_220082_1_, World worldIn, BlockPos pos, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock()) {
         if (!worldIn.isRemote) {
            p_220082_1_ = this.getUpdatedState(worldIn, pos, p_220082_1_, true);
            if (this.disableCorners) {
               p_220082_1_.neighborChanged(worldIn, pos, this, pos, p_220082_5_);
            }
         }
   ...
   public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos, boolean p_220069_6_) {
      if (!worldIn.isRemote) {
         ...
         if (flag && !worldIn.isAirBlock(pos)) {
            ...
            worldIn.removeBlock(pos, p_220069_6_);
         } else {
