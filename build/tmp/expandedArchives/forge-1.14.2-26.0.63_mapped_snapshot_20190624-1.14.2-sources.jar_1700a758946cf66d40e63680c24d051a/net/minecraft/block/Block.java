...
public class Block extends net.minecraftforge.registries.ForgeRegistryEntry<Block> implements IItemProvider, net.minecraftforge.common.extensions.IForgeBlock {
   ...
   public boolean canEntitySpawn(BlockState state, IBlockReader worldIn, BlockPos pos, EntityType<?> type) {
      return hasSolidSide(state, worldIn, pos, Direction.UP);
   }
   ...
   public static boolean func_220064_c(IBlockReader worldIn, BlockPos pos) {
      ...
      return !blockstate.isIn(BlockTags.LEAVES) && !VoxelShapes.compare(blockstate.getCollisionShape(worldIn, pos).func_212434_a(Direction.UP), field_220083_b, IBooleanFunction.ONLY_SECOND);
   }

   public static boolean func_220055_a(IWorldReader worldIn, BlockPos pos, Direction directionIn) {
      BlockState blockstate = worldIn.getBlockState(pos);
      return !blockstate.isIn(BlockTags.LEAVES) && !VoxelShapes.compare(blockstate.getCollisionShape(worldIn, pos).func_212434_a(directionIn), field_220084_c, IBooleanFunction.ONLY_SECOND);
   }
