...
public class ObserverBlock extends DirectionalBlock {
   ...
   public void onBlockAdded(BlockState p_220082_1_, World worldIn, BlockPos pos, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_1_.getBlock() != p_220082_4_.getBlock()) {
         if (!worldIn.isRemote() && p_220082_1_.get(POWERED) && !worldIn.getPendingBlockTicks().isTickScheduled(pos, this)) {
            BlockState blockstate = p_220082_1_.with(POWERED, Boolean.valueOf(false));
