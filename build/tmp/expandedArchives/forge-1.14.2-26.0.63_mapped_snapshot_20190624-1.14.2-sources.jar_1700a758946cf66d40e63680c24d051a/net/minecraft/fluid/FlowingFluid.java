...
public abstract class FlowingFluid extends Fluid {
      ...
      try (BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos = BlockPos.PooledMutableBlockPos.retain()) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (this.isSameOrEmpty(ifluidstate)) {
               float f = ifluidstate.func_215679_a(p_215663_1_, blockpos$pooledmutableblockpos);
               float f1 = 0.0F;
               if (f == 0.0F) {
                  if (!p_215663_1_.getBlockState(blockpos$pooledmutableblockpos).getMaterial().blocksMovement()) {
                     ...
                     if (this.isSameOrEmpty(ifluidstate1)) {
                        f = ifluidstate1.func_215679_a(p_215663_1_, blockpos);
                        if (f > 0.0F) {
                           f1 = p_215663_3_.func_215679_a(p_215663_1_, p_215663_2_) - (f - 0.8888889F);
                        }
                     }
                  }
               } else if (f > 0.0F) {
                  f1 = p_215663_3_.func_215679_a(p_215663_1_, p_215663_2_) - f;
               }
   ...
   protected boolean causesDownwardCurrent(IBlockReader worldIn, BlockPos neighborPos, Direction side) {
      ...
      if (ifluidstate.getFluid().isEquivalentTo(this)) {
         ...
         return blockstate.getMaterial() == Material.ICE ? false : Block.hasSolidSide(blockstate, worldIn, neighborPos, side);
      }
   }
   ...
   public float func_215662_a(IFluidState p_215662_1_, IBlockReader p_215662_2_, BlockPos p_215662_3_) {
      return func_215666_c(p_215662_1_, p_215662_2_, p_215662_3_) ? 1.0F : (float)p_215662_1_.getLevel() / 9.0F;
   }
