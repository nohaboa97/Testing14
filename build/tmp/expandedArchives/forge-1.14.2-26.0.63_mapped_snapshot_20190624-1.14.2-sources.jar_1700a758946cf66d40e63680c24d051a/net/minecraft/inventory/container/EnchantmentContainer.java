...
public class EnchantmentContainer extends Container {
   ...
   public EnchantmentContainer(int p_i50086_1_, PlayerInventory p_i50086_2_, IWorldPosCallable p_i50086_3_) {
      ...
      this.func_216958_a(IntReferenceHolder.create(this.enchantLevels, 0));
      this.func_216958_a(IntReferenceHolder.create(this.enchantLevels, 1));
      this.func_216958_a(IntReferenceHolder.create(this.enchantLevels, 2));
      this.func_216958_a(this.xpSeed).set(p_i50086_2_.player.getXPSeed());
      this.func_216958_a(IntReferenceHolder.create(this.enchantClue, 0));
      this.func_216958_a(IntReferenceHolder.create(this.enchantClue, 1));
      this.func_216958_a(IntReferenceHolder.create(this.enchantClue, 2));
      this.func_216958_a(IntReferenceHolder.create(this.worldClue, 0));
      this.func_216958_a(IntReferenceHolder.create(this.worldClue, 1));
      this.func_216958_a(IntReferenceHolder.create(this.worldClue, 2));
   }
