...
public abstract class Container {
   ...
   protected static boolean isWithinUsableDistance(IWorldPosCallable p_216963_0_, PlayerEntity p_216963_1_, Block p_216963_2_) {
      return p_216963_0_.applyOrElse((p_216960_2_, p_216960_3_) -> {
         return p_216960_2_.getBlockState(p_216960_3_).getBlock() != p_216963_2_ ? false : p_216963_1_.getDistanceSq((double)p_216960_3_.getX() + 0.5D, (double)p_216960_3_.getY() + 0.5D, (double)p_216960_3_.getZ() + 0.5D) <= 64.0D;
      }, true);
   }
   ...
   protected void func_216961_a(IIntArray p_216961_1_) {
      for(int i = 0; i < p_216961_1_.size(); ++i) {
         this.func_216958_a(IntReferenceHolder.create(p_216961_1_, i));
      }
   ...
   public void updateProgressBar(int id, int data) {
      this.field_216964_d.get(id).set(data);
   }
