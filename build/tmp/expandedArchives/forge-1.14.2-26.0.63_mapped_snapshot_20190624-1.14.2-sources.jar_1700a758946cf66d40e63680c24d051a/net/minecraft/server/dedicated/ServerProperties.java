...
public class ServerProperties extends PropertyManager<ServerProperties> {
   ...
   public final Difficulty difficulty = this.func_218983_a("difficulty", func_218964_a(Difficulty::byId, Difficulty::func_219963_a), Difficulty::getTranslationKey, Difficulty.EASY);
